...
public class AndroidOpenGLActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d("FUCK", "Activity.onCreate memory usage at start: "
				+ getUsedMemorySize());
		...
		gameField.getCellAt(5, 4).setHeight(2)
				.setLightState(CellLightState.LIGHT_OFF);
		gameField.getCellAt(3, 4).setHeight(1)
				.setLightState(CellLightState.LIGHT_ON);
		for (int i = 0; i < 10; ++i) {
